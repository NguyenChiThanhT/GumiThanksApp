...
import {
    View, Image, Dimensions, TouchableOpacity, Platform,ImageBackground
} from 'react-native';
import Icon from 'react-native-vector-icons/SimpleLineIcons';
import {getStyleFromProps, getPlatformValue} from '../../utils/index';
...
export default class BackgroundWrapper extends Component {
    ...
    renderImageBackground() {
        ...
        return <ImageBackground source={require('../../asset/images/logo2.jpg')} style={style}>
            {this.renderChildren()}
        </ImageBackground>
    }
